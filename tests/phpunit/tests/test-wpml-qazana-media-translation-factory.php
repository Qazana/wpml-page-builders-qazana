...
/**
 * Class Test_WPML_Qazana_Media_Translation_Factory
 *
 ...
 * @group wpmlmedia-511
 */
class Test_WPML_Qazana_Media_Translation_Factory extends OTGS_TestCase {

	/**
	 * @test
	 */
	public function it_creates_instance_of_media_translation_when_media_classes_are_present() {
		$subject = new WPML_Qazana_Media_Translation_Factory();
		...
		$this->assertInstanceOf( 'WPML_Qazana_Media_Translation', $subject->create() );
	}
