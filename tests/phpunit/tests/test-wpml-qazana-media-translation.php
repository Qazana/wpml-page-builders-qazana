...
/**
 * Class Test_Qazana_Media_Translation
 *
 * @group wpmlmedia-511
 */
class Test_Qazana_Media_Translation extends OTGS_TestCase {
	...
	public function it_adds_hooks() {
		...
		$subject = new WPML_Qazana_Media_Translation( $data_settings, $image_translate, $translation_element_factory );
