...
class WPML_Qazana_URLs implements IWPML_Action {
	...
	public function add_hooks() {
		add_filter( 'qazana/document/urls/edit', array( $this, 'adjust_edit_with_qazana_url' ), 10, 2 );
	}

	public function adjust_edit_with_qazana_url( $url, $qazana_document ) {
		$post = $qazana_document->get_main_post();
