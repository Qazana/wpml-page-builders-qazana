...
/**
 * Class WPML_Qazana_Translatable_Nodes
 */
class WPML_Qazana_Translatable_Nodes implements IWPML_Page_Builders_Translatable_Nodes {
	...
	/**
	 * WPML_Qazana_Translatable_Nodes constructor.
	 */
	...
	public function initialize_nodes_to_translate() {
		...
		$this->nodes_to_translate = array(
			...
			'toggle'      => array(
				...
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Toggle',
			),
			'accordion'   => array(
				'conditions'        => array( $this->type => 'accordion' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Accordion',
			),
			'testimonial-carousel'   => array(
				'conditions'        => array( $this->type => 'testimonial-carousel' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Testimonial_Carousel',
			),
			'tabs'        => array(
				'conditions'        => array( $this->type => 'tabs' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Tabs',
			),
			'price-list'  => array(
				'conditions'        => array( $this->type => 'price-list' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Price_List',
			),
			'icon-list'   => array(
				'conditions'        => array( $this->type => 'icon-list' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Icon_List',
			),
			'slides'      => array(
				'conditions'        => array( $this->type => 'slides' ),
				'fields'            => array(),
				'integration-class' => 'WPML_Qazana_Slides',
			),
			'price-table' => array(
				...
				'integration-class' => 'WPML_Qazana_Price_Table',
			),
			'form'        => array(
				...
				'integration-class' => 'WPML_Qazana_Form',
			),
			'posts'       => array(
		...
		$this->nodes_to_translate = apply_filters( 'wpml_qazana_widgets_to_translate', $this->nodes_to_translate );
	}
}