...
/**
 * Class WPML_Qazana_Module_With_Items
 */
abstract class WPML_Qazana_Module_With_Items implements IWPML_Page_Builders_Module {
	...
	public function get_items( $element ) {
		return $element[ WPML_Qazana_Translatable_Nodes::SETTINGS_FIELD ][ $this->get_items_field() ];
	}
